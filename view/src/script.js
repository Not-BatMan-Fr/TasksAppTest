...
function fetchTasks() {
    return __awaiter(this, void 0, void 0, function () {
        var response, tasks, list;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('http://127.0.0.1:8000/tasks')];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    ...
                    tasks.forEach(function (task) {
                        ...
                        li.textContent = "".concat(task.title, " - [").concat(task.status, "]");
                        list.appendChild(li);
                    });
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch('http://127.0.0.1:8000/tasks', {
                            method: 'POST',
